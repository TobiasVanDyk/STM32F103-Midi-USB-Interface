...
Check that both boot0 and boot1 selections are on 0. Plug your Blue Pill it into the PC USB Port and check that a new sound device named Midi is present. You may want to install [**MidiOx**](http://www.midiox.com/) to check that all four input and four output Midi ports are available.
